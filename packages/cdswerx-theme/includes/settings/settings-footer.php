...
class Settings_Footer extends Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Hello Theme Footer', 'cdswerx-theme' );
	}
	...
	protected function register_tab_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				'label' => esc_html__( 'Footer', 'cdswerx-theme' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::SWITCHER,
				'label' => esc_html__( 'Copyright', 'cdswerx-theme' ),
				'default' => 'yes',
				'label_on' => esc_html__( 'Show', 'cdswerx-theme' ),
				'label_off' => esc_html__( 'Hide', 'cdswerx-theme' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Text', 'cdswerx-theme' ),
				'default' => esc_html__( 'All rights reserved', 'cdswerx-theme' ),
			]
		);
	...
	public function get_additional_tab_content() {
		...
		if ( ! defined( 'ELEMENTOR_PRO_VERSION' ) ) {
			return sprintf(
				...
				esc_html__( 'Create custom footers', 'cdswerx-theme' ),
				esc_html__( 'Adjust your footer to include contact forms, sitemaps and more with Elementor Pro.', 'cdswerx-theme' ),
			...
			return sprintf(
				...
				esc_html__( 'Create a custom footer with the Theme Builder', 'cdswerx-theme' ),
				...
				esc_html__( 'Create Footer', 'cdswerx-theme' )
			);
		}
	}
}
