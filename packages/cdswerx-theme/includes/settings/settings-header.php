...
namespace CDSWerx\Includes\Settings;
...
class Settings_Header extends Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Hello Theme Header', 'cdswerx-theme' );
	}
	...
	protected function register_tab_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				'label' => esc_html__( 'Header', 'cdswerx-theme' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Site Logo', 'cdswerx-theme' ),
				'default' => 'yes',
				'label_on' => esc_html__( 'Show', 'cdswerx-theme' ),
				'label_off' => esc_html__( 'Hide', 'cdswerx-theme' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::SWITCHER,
				'label' => esc_html__( 'Tagline', 'cdswerx-theme' ),
				'default' => 'yes',
				'label_on' => esc_html__( 'Show', 'cdswerx-theme' ),
				'label_off' => esc_html__( 'Hide', 'cdswerx-theme' ),
			]
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::SWITCHER,
				'label' => esc_html__( 'Menu', 'cdswerx-theme' ),
				'default' => 'yes',
				'label_on' => esc_html__( 'Show', 'cdswerx-theme' ),
				'label_off' => esc_html__( 'Hide', 'cdswerx-theme' ),
			]
		...
		$this->add_control(
			...
			[
				...
				'content' => sprintf(
					...
					__( 'Note: Hiding all the elements, only hides them visually. To disable them completely go to <a href="%s">Theme Settings</a> .', 'cdswerx-theme' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Layout', 'cdswerx-theme' ),
				'options' => [
					'inverted' => [
						'title' => esc_html__( 'Inverted', 'cdswerx-theme' ),
						'icon' => "eicon-arrow-$start",
					],
					'stacked' => [
						'title' => esc_html__( 'Centered', 'cdswerx-theme' ),
						'icon' => 'eicon-h-align-center',
					],
					'default' => [
						'title' => esc_html__( 'Default', 'cdswerx-theme' ),
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::CHOOSE,
				'label' => esc_html__( 'Tagline Position', 'cdswerx-theme' ),
				'options' => [
					'before' => [
						'title' => esc_html__( 'Before', 'cdswerx-theme' ),
						'icon' => "eicon-arrow-$start",
					],
					'below' => [
						'title' => esc_html__( 'Below', 'cdswerx-theme' ),
						'icon' => 'eicon-arrow-down',
					],
					'after' => [
						'title' => esc_html__( 'After', 'cdswerx-theme' ),
						'icon' => "eicon-arrow-$end",
					],
				],
				'toggle' => false,
		...
		$this->add_responsive_control(
			...
			[
				...
				'label' => esc_html__( 'Tagline Gap', 'cdswerx-theme' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Width', 'cdswerx-theme' ),
				'options' => [
					'boxed' => esc_html__( 'Boxed', 'cdswerx-theme' ),
					'full-width' => esc_html__( 'Full Width', 'cdswerx-theme' ),
				],
				'selector' => '.site-header',
				'default' => 'boxed',
				'separator' => 'before',
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Content Width', 'cdswerx-theme' ),
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Side Margins', 'cdswerx-theme' ),
				'size_units' => [ '%', 'px', 'em ', 'rem', 'vw', 'custom' ],
				'default' => [
					'size' => '0',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'cdswerx-theme' ),
		...
		$this->add_control(
			...
			[
				...
				'content' => sprintf(
					...
					__( 'Go to <a href="%s">Site Identity</a> to manage your site\'s logo', 'cdswerx-theme' ),
		...
		$this->add_control(
			...
			[
				...
				'content' => sprintf(
					/* translators: %s: Link that opens Elementor's "Site Identity" panel. */
					__( 'Go to <a href="%s">Site Identity</a> to manage your site\'s title', 'cdswerx-theme' ),
					"javascript:\$e.route('panel/global/settings-site-identity')"
				),
				'render_type' => 'ui',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Type', 'cdswerx-theme' ),
				'type' => Controls_Manager::SELECT,
				'default' => ( has_custom_logo() ? 'logo' : 'title' ),
				'options' => [
					'logo' => esc_html__( 'Logo', 'cdswerx-theme' ),
					'title' => esc_html__( 'Title', 'cdswerx-theme' ),
				],
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Logo Width', 'cdswerx-theme' ),
				'size_units' => [ '%', 'px', 'em', 'rem', 'vw', 'custom' ],
				'range' => [
					'px' => [
						'max' => 1000,
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'cdswerx-theme' ),
				'condition' => [
					'hello_header_logo_display' => 'yes',
					'hello_header_logo_type' => 'title',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Text Shadow', 'cdswerx-theme' ),
				'condition' => [
					'hello_header_logo_display' => 'yes',
					'hello_header_logo_type' => 'title',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Text Stroke', 'cdswerx-theme' ),
				'condition' => [
					'hello_header_logo_display' => 'yes',
					'hello_header_logo_type' => 'title',
				],
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Normal', 'cdswerx-theme' ),
				'condition' => [
					'hello_header_logo_display' => 'yes',
					'hello_header_logo_type' => 'title',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text Color', 'cdswerx-theme' ),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Hover', 'cdswerx-theme' ),
				'condition' => [
					'hello_header_logo_display' => 'yes',
					'hello_header_logo_type' => 'title',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Transition Duration', 'cdswerx-theme' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_control(
			...
			[
				...
				'content' => sprintf(
					/* translators: %s: Link that opens Elementor's "Site Identity" panel. */
					__( 'Go to <a href="%s">Site Identity</a> to manage your site\'s tagline', 'cdswerx-theme' ),
					"javascript:\$e.route('panel/global/settings-site-identity')"
				),
				'render_type' => 'ui',
				'condition' => [
		...
		$menus = [ '0' => esc_html__( '— Select a Menu —', 'cdswerx-theme' ) ];
		...
		if ( 1 === count( $menus ) ) {
			$this->add_control(
				...
				[
					'type' => Controls_Manager::ALERT,
					'alert_type' => 'info',
					'heading' => esc_html__( 'There are no menus in your site.', 'cdswerx-theme' ),
					'content' => sprintf(
						__( 'Go to <a href="%s" target="_blank">Menus screen</a> to create one.', 'cdswerx-theme' ),
			...
			$this->add_control(
				...
				[
					...
					'alert_type' => 'info',
					'content' => sprintf(
						__( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus. Changes will be reflected in the preview only after the page reloads.', 'cdswerx-theme' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Menu Layout', 'cdswerx-theme' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'horizontal',
					'options' => [
						'horizontal' => esc_html__( 'Horizontal', 'cdswerx-theme' ),
						'dropdown' => esc_html__( 'Dropdown', 'cdswerx-theme' ),
					],
					'frontend_available' => true,
				]
			);
			...
			foreach ( $active_breakpoints as $breakpoint_key => $breakpoint_instance ) {
				...
				$dropdown_options[ $breakpoint_key ] = sprintf(
					...
					esc_html__( '%1$s (> %2$dpx)', 'cdswerx-theme' ),
					$breakpoint_instance->get_label(),
					$breakpoint_instance->get_value()
				);
			}

			$dropdown_options['none'] = esc_html__( 'None', 'cdswerx-theme' );

			$this->add_control(
				'hello_header_menu_dropdown',
				[
					'label' => esc_html__( 'Breakpoint', 'cdswerx-theme' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'tablet',
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Color', 'cdswerx-theme' ),
					'type' => Controls_Manager::COLOR,
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Toggle Color', 'cdswerx-theme' ),
					'type' => Controls_Manager::COLOR,
					'condition' => [
						'hello_header_menu_display' => 'yes',
					],
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Toggle Background Color', 'cdswerx-theme' ),
					'type' => Controls_Manager::COLOR,
					'condition' => [
						'hello_header_menu_display' => 'yes',
					],
	...
	public function get_additional_tab_content() {
		...
		if ( ! defined( 'ELEMENTOR_PRO_VERSION' ) ) {
			return sprintf(
				...
				esc_attr__( 'Get Elementor Pro', 'cdswerx-theme' ),
				esc_html__( 'Create custom headers', 'cdswerx-theme' ),
				esc_html__( 'Add mega menus, search bars, login buttons and more with Elementor Pro.', 'cdswerx-theme' ),
				'https://go.elementor.com/hello-theme-header/',
				esc_html__( 'Upgrade Now', 'cdswerx-theme' )
			);
		} else {
			return sprintf(
				$content_template,
				get_template_directory_uri() . '/assets/images/go-pro.svg',
				esc_attr__( 'Elementor Pro', 'cdswerx-theme' ),
				esc_html__( 'Create a custom header with the Theme Builder', 'cdswerx-theme' ),
				esc_html__( 'With the Theme Builder you can jump directly into each part of your site', 'cdswerx-theme' ),
				get_admin_url( null, 'admin.php?page=elementor-app#/site-editor/templates/header' ),
				esc_html__( 'Create Header', 'cdswerx-theme' )
			);
		}
	}
}
