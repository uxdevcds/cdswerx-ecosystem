		...
		switch ( $action_link_type ) {
			case 'install-elementor':
				$action_link_data = [
					...
					'alt' => esc_attr__( 'Elementor', 'cdswerx-theme' ),
					'title' => esc_html__( 'Install Elementor', 'cdswerx-theme' ),
					'message' => esc_html__( 'Create cross-site header & footer using Elementor.', 'cdswerx-theme' ),
					'button' => esc_html__( 'Install Elementor', 'cdswerx-theme' ),
					'link' => wp_nonce_url(
						add_query_arg(
							[
			...
			case 'activate-elementor':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'cdswerx-theme' ),
					'title' => esc_html__( 'Activate Elementor', 'cdswerx-theme' ),
					'message' => esc_html__( 'Create cross-site header & footer using Elementor.', 'cdswerx-theme' ),
					'button' => esc_html__( 'Activate Elementor', 'cdswerx-theme' ),
			...
			case 'activate-header-footer-experiment':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'cdswerx-theme' ),
					'title' => esc_html__( 'Style using Elementor', 'cdswerx-theme' ),
					'message' => esc_html__( 'Design your cross-site header & footer from Elementor’s "Site Settings" panel.', 'cdswerx-theme' ),
					'button' => esc_html__( 'Activate header & footer experiment', 'cdswerx-theme' ),
			...
			case 'style-header-footer':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'cdswerx-theme' ),
					'title' => esc_html__( 'Style cross-site header & footer', 'cdswerx-theme' ),
					'message' => esc_html__( 'Customize your cross-site header & footer from Elementor’s "Site Settings" panel.', 'cdswerx-theme' ),
					'button' => esc_html__( 'Start Designing', 'cdswerx-theme' ),
