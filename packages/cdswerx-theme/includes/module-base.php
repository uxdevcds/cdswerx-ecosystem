...
namespace CDSWerxTheme\Includes;
 ...
 * @subpackage CDSWerxThemeModules
 */
abstract class Module_Base {
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Something went wrong.', 'cdswerx-theme' ), '0.0.1' ); // @codeCoverageIgnore
	}
